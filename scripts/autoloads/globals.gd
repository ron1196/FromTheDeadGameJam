...
const GROUP_PLAYER_INVENTORY: String = "player_inventory"

const INPUT_SELECT: String = "select"
const INPUT_COMMAND: String = "command"
const INPUT_OPEN_BUILDER: String = "open_builder"

const PROPERTY_DIRECTION: String = "direction"

var options_edge_scrolling: bool = true
var options_input_scrolling: bool = true
